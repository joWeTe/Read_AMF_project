...
# AMF_RESULTS_CSV_3.csv --> CSV file containing all data related to root colonisation assessment. Contains all colonisation metrics: F_RS; IC_RS; IC_RF; AA_RS; AA_RF; VA_RS; VA_RF, for all 80 samples.
